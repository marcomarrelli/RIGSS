...
from PyQt5.QtGui import QGuiApplication, QFontDatabase, QIcon
...
from model.reviewModel import Reviews
...
if __name__ == '__main__':
    ...
    app.setWindowIcon(QIcon(os.fspath(CURRENT_DIRECTORY / "gui" / "resources" / "rigss-no-bg.svg")))
    ...
    qmlRegisterType(Reviews, 'Reviews', 1, 0, 'Reviews')
    qmlRegisterType(Transactions, 'Transactions', 1, 0, 'Transactions')
